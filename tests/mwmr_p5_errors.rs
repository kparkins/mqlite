...
mod post_register {
    ...
    fn test_flush_failure_after_register_cleans_up() {
        ...
        // contract covered by `tests/mwmr_p5_crash.rs`.
        assert_post_register_cleanup_with_options(
    ...
    #[test]
    fn test_commit_header_read_failure_after_register_cleans_up() {
        assert_post_register_cleanup(
    ...
    #[test]
    fn test_legacy_commit_txn_failure_after_register_cleans_up() {
        assert_post_register_cleanup(
    ...
    #[test]
    fn test_rollback_txn_failure_after_structural_commit_cleans_up() {
        assert_post_register_cleanup(
