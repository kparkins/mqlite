...
**YOU ARE IN: `mqlite/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mqlite/` (rig root) or other directories
...
**Your mail address:** `mqlite/polecats/furiosa`
**Your rig:** mqlite
**Your Witness:** `mqlite/witness`
...
| Ask Witness for help | `gt mail send mqlite/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mqlite/witness`) when:
...
```bash
gt mail send mqlite/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
